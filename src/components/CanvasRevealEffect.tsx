...
export const CanvasRevealEffect = ({
  ...
  return (
    <div style={{ height: '100%', position: 'relative', width: '100%', zIndex: 0 }}>
      ...
      {showGradient && (
         <div style={{ position: 'absolute', top: '0', right: '0', bottom: '0', left: '0', background: 'linear-gradient(to top, var(--background), transparent)' }} />
      )}
    </div>
  );
};
